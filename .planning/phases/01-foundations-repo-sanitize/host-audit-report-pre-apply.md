...
**Run at:** 2026-05-25T15:36:30+00:00  
...
| Check | Expected | Actual | Status |
| --- | --- | --- | --- |
| /home/toto/jarvis | toto:toto 755/750 | toto:toto 775 | WARN |
| /home/toto/lumio | toto:toto 755/750 | assente | MISSING |
| /etc/cloudflared | root:cloudflared 750 | root:root 755 | WARN |
| group cloudflared | esistente | assente | MISSING |
...
| ufw Status | active | inactive | MISSING |
| ufw Default incoming | deny | <sconosciuto> | MISSING |
| regola SSH su tailscale0 | ALLOW IN 22/tcp on tailscale0 | assente | MISSING |
...
_Run_ `bin/host-apply.sh` _per applicare i fix proposti (richiede sudo)._